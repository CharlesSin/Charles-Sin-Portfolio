  ...
  return (
    <div className="relative lg:static xl:pl-10">
      <div className="absolute inset-x-[-50vw] -top-32 -bottom-48 [mask-image:linear-gradient(transparent,white,white)] dark:[mask-image:linear-gradient(transparent,white,transparent)] lg:left-[calc(50%+14rem)] lg:right-0 lg:-top-32 lg:-bottom-32 lg:[mask-image:none] lg:dark:[mask-image:linear-gradient(white,white,transparent)]">
        <svg
          ...
          <g opacity=".4" clipPath="url(#:R1l6:-clip-path)" strokeWidth="4">
            ...
            <circle cx="484.301" cy="574.062" r="10.438" transform="rotate(-180 484.301 574.062)" fill="#0EA5E9" fillOpacity=".42" stroke="#0EA5E9"></circle>
            ...
            <circle cx="83.5" cy="484.3" r="10.438" transform="rotate(-180 83.5 484.3)" fill="#0EA5E9" fillOpacity=".42" stroke="#0EA5E9"></circle>
      ...
      <div className="relative">
        <img alt="" src="/images/glassify/blur-cyan-2.png" width="530" height="530" decoding="async" data-nimg="1" className="absolute -top-64 -right-64" />
        <img alt="" src="/images/glassify/blur-indigo-1.png" width="567" height="567" decoding="async" data-nimg="1" className="absolute -bottom-40 -right-44" />
